  ...
  public void actionPerformed(ActionEvent e)
  {
	  if(e.getSource()==jbcompile)
	  {
		  ...
		  if(!jtf.getText().equals(""))
		  {
			  try
			  {
				  ...
				  Process error=r.exec("C:\\Program Files\\Java\\jdk1.8.0_271\\bin\\javac.exe -d .  "+fname);
				  ...
				  if(result.equals(""))
				  {
					  jta1.setText("Compilation successfully"+fname);
					  err.close();
				  }
				  else
					  jta1.setText(result);
	  ...
	  else if(e.getSource()==jbrun)
	  {
		  ...
		  try{
			  ...
			  Process p=r.exec("C:\\Program Files\\Java\\jdk1.8.0_271\\bin\\java -cp .  "+fn);
